...
handler.all = async function (m) {
    ...
    //creador y otros
    global.creador = 'Wa.me/56920027086'
    global.ofcbot = `${conn.user.jid.split('@')[0]}`
    global.asistencia = 'https://wa.me/qr/PAOHAKCEHGUXN1'
    global.namechannel = 'JEONBOT'
    ...
    //Emojis determinado de JEONBOT Bot
    global.emoji = '🍁'
    global.emoji2 = '⭐'
    global.emoji3 = '✨️'
    global.emoji4 = '😴'
    ...
    // global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "56920027086-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: `${packname}`, orderTitle: 'Bang', thumbnail: icons, sellerJid: '0@s.whatsapp.net'}}}
    ...
    global.icono = [
        'https://i.ibb.co/9kgFx7TS/catalogo.png',
        'https://i.ibb.co/9kgFx7TS/catalogo.png',
        'https://i.ibb.co/9kgFx7TS/catalogo.png'
    ].getRandom()
