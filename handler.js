...
global.dfail = (type, m, conn) => {
    const msg = {
        rowner: `🚩 Hola, este comando solo puede ser utilizado por *JEONBOT*.`,
        owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *JEONBOT*.`,
        mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *JEONBOT*.`,
